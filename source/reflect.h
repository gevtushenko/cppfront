...
#line 315 "reflect.h2"
    ...
    public: [[nodiscard]] auto make_heterogeneous() & -> bool;
...
#line 310 "reflect.h2"
    ...
    [[nodiscard]] auto function_declaration::make_heterogeneous() & -> bool { return CPP2_UFCS_0(make_function_heterogeneous, (*cpp2::assert_not_null(n))); }
...
auto heterogeneous(meta::type_declaration& t) -> void
{
    for ( auto& m : CPP2_UFCS_0(get_members, t) ) 
    {
        if (CPP2_UFCS_0(is_function, m)) {
            auto mf {CPP2_UFCS_0(as_function, m)}; 
            CPP2_UFCS_0(make_heterogeneous, mf);
        }
    }
}
}
